...
const labelClass = computed(() => {
  ...
  // 订阅类型：统一主题色（分组不再按平台区分）
  return `${base} bg-violet-200/60 text-violet-800 dark:bg-violet-800/40 dark:text-violet-300`
})

// Badge color: group styling is platform-agnostic. `platform` remains optional for
// compatibility with older callers but is not rendered or used for colors.
