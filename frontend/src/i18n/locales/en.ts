export default {
  ...
  keys: {
    ...
    useKeyModal: {
      ...
      copilot: {
        description: 'Configure Copilot CLI with the current key. Available models depend on the account permissions in this key\'s current group.',
        note: 'Different Copilot CLI versions may use different variable names. If your client expects OpenAI-compatible settings, use the same Base URL and API Key in the matching fields.',
        hint: 'If Copilot CLI does not read COPILOT_* variables, enter the equivalent Base URL/API Key fields in the client configuration.',
      },
    },
    ...
    ccsClientSelect: {
      title: 'Select Client',
      description: 'Select the target client to import into CC-Switch. The generated configuration follows that client protocol:',
      claudeCode: 'Claude Code',
      ...
      openclaw: 'OpenClaw',
      openclawDesc: 'Import as OpenClaw configuration',
      antigravity: 'Antigravity',
      antigravityDesc: 'Import as Antigravity-compatible configuration',
      copilotCli: 'Copilot CLI',
      copilotCliDesc: 'Import as GitHub Copilot CLI configuration',
    },
  ...
  admin: {
    ...
    groups: {
      ...
      description: 'Manage cross-platform account pools, API key groups, and rate multipliers',
      searchGroups: 'Search groups...',
      ...
      allPlatforms: 'All Compatibility Platforms',
      allStatus: 'All Status',
      allGroups: 'All Groups',
      exclusive: 'Exclusive',
      ...
      platformHint: 'This field is legacy/default protocol metadata. A group can contain accounts from any platform.',
      platformNotEditable: 'Default platform cannot be changed after creation, but accounts from any platform can join this group.',
      legacyPlatform: 'Compat: {platform}',
