  ...
  admin: {
    ...
    accounts: {
      ...
      openai: {
        ...
        fastPassthrough: '允许用户 /fast 模式',
        fastPassthroughBadge: 'Fast 透传',
        fastPassthroughDescOff:
          '默认关闭。关闭时会移除 Codex /fast 传来的 service_tier=fast/priority，上游按普通优先级处理。',
        fastPassthroughDescOn:
          '开启后会把 Codex /fast 归一化并透传为 OpenAI service_tier=priority。',
        fastPassthroughWarning:
          '可能消耗 fast/priority 配额并影响成本或限额，请仅为承接 Fast 流量的账号开启。',
