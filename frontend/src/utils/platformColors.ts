...
export type Platform = 'anthropic' | 'openai' | 'antigravity' | 'gemini' | 'copilot'
...
const BADGE: Record<Platform, string> = {
  ...
  copilot: 'bg-slate-500/10 text-slate-700 border-slate-500/30 dark:text-slate-300',
}
...
const BADGE_LIGHT: Record<Platform, string> = {
  ...
  copilot: 'bg-slate-500/10 text-slate-700 dark:bg-slate-500/10 dark:text-slate-300',
}
...
const BORDER: Record<Platform, string> = {
  ...
  copilot: 'border-slate-500/20 dark:border-slate-500/20',
}
...
const ACCENT_BAR: Record<Platform, string> = {
  ...
  copilot: 'bg-gradient-to-r from-slate-400 to-slate-500',
}
...
const TEXT: Record<Platform, string> = {
  ...
  copilot: 'text-slate-600 dark:text-slate-300',
}
...
const ICON: Record<Platform, string> = {
  ...
  copilot: 'text-slate-500 dark:text-slate-300',
}
...
const BUTTON: Record<Platform, string> = {
  ...
  copilot: 'bg-slate-600 text-white hover:bg-slate-700 active:bg-slate-800 dark:bg-slate-600/80 dark:hover:bg-slate-600',
}
...
const DISCOUNT: Record<Platform, string> = {
  ...
  copilot: 'bg-slate-100 text-slate-700 dark:bg-slate-900/40 dark:text-slate-300',
}
...
const GRADIENT: Record<Platform, string> = {
  ...
  copilot: 'from-slate-500 to-slate-600',
}
...
function isPlatform(p: string): p is Platform {
  return p === 'anthropic' || p === 'openai' || p === 'antigravity' || p === 'gemini' || p === 'copilot'
}
